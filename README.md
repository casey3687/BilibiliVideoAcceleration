...
```text
C:\BilibiliVideoAcceleration\dist\bilibili-playback-rate-menu-0.1.0.zip
```
...
4. 扩展程序根目录选择：
   ...
   ```text
   C:\BilibiliVideoAcceleration\dist\bilibili-playback-rate-menu-0.1.0
   ```
